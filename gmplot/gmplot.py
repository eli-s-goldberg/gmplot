...
class GoogleMapPlotter(object):
	def __init__(self, center_lat, center_lng, zoom, api_key=''):
	...
	def draw(self, htmlfile, api_key=None):
		...
		if self.api_key:
			f.write(
				...
				'src="https://maps.googleapis.com/maps/api/js?libraries=visualization&sensor=true_or_false&key=%s'
				'"></script>\n' % self.api_key)
		else:
			f.write(
				'<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?libraries=visualization'
                '&sensor=true_or_false"></script>\n')
