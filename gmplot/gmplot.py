...
class GoogleMapPlotter(object):
    ...
    def draw(self, htmlfile, api_key=None):
        ...
        # remove sensor=true_or_false - no loonger required for google API.
    ...
    # def write_heat_map_gapi_style (self, f):
    ...
    def write_point(self, f, lat, lon, color, title):
        ...
        # remove the icon write to use default pins.
        # f.write('\t\ticon: img,\n')
